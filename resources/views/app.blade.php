...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" @class(['dark' => ($appearance ?? 'system') == 'dark'])>
    <head>
        ...
        {{-- SEO --}}
        <meta name="description" content="TiketMark: compra entradas para tus eventos favoritos, elige tu ubicación, paga con QR y recibe tu acceso digital. También productos oficiales en la tienda.">
        <meta name="keywords" content="entradas, tickets, eventos, conciertos, teatro, compra de entradas, TiketMark">
        <meta name="author" content="TiketMark">
        ...
        <meta property="og:site_name" content="TiketMark">
        ...
        <x-inertia::head>
            <title>{{ config('app.name', 'TiketMark') }}</title>
        </x-inertia::head>
    </head>
